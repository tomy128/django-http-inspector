...
```text
dist/django_http_inspector-0.1.2.tar.gz
dist/django_http_inspector-0.1.2-py3-none-any.whl
```
...
/tmp/django-http-inspector-release-check/bin/python -m pip install dist/django_http_inspector-0.1.2-py3-none-any.whl
...
```bash
python -m pip install django-http-inspector==0.1.2
